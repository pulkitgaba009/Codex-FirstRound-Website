function QuizQuestionsList({ questions, activeId, onSelect, answers }) {
  return (
    <div className="w-full h-[90%] overflow-x-auto md:overflow-y-auto md:overflow-x-hidden scrollbar-hidden mt-2 md:mt-0">
      <div className="px-4 pb-4 mt-[5px] md:mt-4 text-white gap-4 flex flex-nowrap md:flex-wrap min-w-max md:min-w-0 items-center md:justify-start">
